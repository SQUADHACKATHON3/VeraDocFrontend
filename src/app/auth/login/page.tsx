        ...
        <div className="w-full lg:w-[45%] xl:w-[40%] flex items-center justify-center p-6 md:p-12 pt-40 lg:pt-32 relative z-10">
          <div className="w-full max-w-md glass p-8 md:p-10 rounded-[2.5rem] reveal active">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  ...
                  <Link href="/auth/forgot-password" title="Reset your password" className="text-xs font-bold text-primary hover:text-primary-light transition-colors">Forgot password?</Link>
                </div>
            ...
            <div className="my-8 flex items-center gap-4">
              ...
              <span className="text-foreground/30 text-xs font-bold uppercase tracking-widest">or</span>
              <div className="h-px flex-1 bg-card-border"></div>
            </div>
            ...
            <button
              ...
              className="w-full bg-white hover:bg-white/90 text-black font-medium py-4 rounded-2xl transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3"
            >

...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-canvas text-foreground font-sans flex items-center justify-center px-6">
      <div className="relative z-10 text-center max-w-md">
        <div className="w-16 h-16 rounded-2xl bg-card border border-border flex items-center justify-center mx-auto mb-8">
          <FileQuestion className="w-8 h-8 text-forest-light" />
        </div>
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 bg-forest hover:bg-forest-mid text-ink px-8 py-4 rounded-full font-bold transition-all hover:scale-105"
        >
